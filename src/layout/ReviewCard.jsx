        ...
        <div className=" w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg hover: shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all">
            <div>
                <p className=" text-lightText">
                    ...
                    maxime omnis facere molestiae eius! Iusto provident ducimus 
                    mollitia adipisci debitis consequatur laborum magni deleniti dolorem
                    in sit est repudiandae ratione.
                </p>
            </div>
